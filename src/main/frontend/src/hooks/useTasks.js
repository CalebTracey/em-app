...
const useTasks = () => {
    ...
    useEffect(() => {
        if (!tasksLoaded) {
            ...
            const date = new Date(Date.UTC(myDate.getUTCFullYear(), myDate.getUTCMonth(), myDate.getUTCDate()));
            ...
            ({
                taskName: faker.fake("{{company.bsBuzz}} {{company.bsAdjective}} {{company.bsNoun}}"),
